...
pdf("Distrabution of Females for all Genera.pdf") # start saving as pdf
...
pdf("Relationship of Weight and Hindfoot Length in Dipodomys merriami.pdf") # start saving as pdf
...
pdf("Comparison of Male and Female Weight for Genus Dipodomys.pdf") # start saving as pdf
...
w <- surveys %>% # created object w
  ...
  filter (!is.na (weight)) # filter out NA weight values
pdf("Comparison of Male and Female Weight for Dipodomys spectabilis.pdf") # start saving as pdf
